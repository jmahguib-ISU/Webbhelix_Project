# to create genlight object from plink.raw file 
liSNPs = read.PLINK("/Users/jermaine/ISU_Projects/Webbhelix_Project/Plink_Program_outputs/TrkNbr_1282_L2_RepPairs/plink_3230.raw")
param = "plink_3230"
...
results = SNP_error(liSNPs,param)
results

## to conduct PCA analysis
class(liSNPs)
liSNPs
table(liSNPs@pop)
